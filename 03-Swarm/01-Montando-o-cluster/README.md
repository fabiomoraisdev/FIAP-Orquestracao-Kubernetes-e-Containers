...
9.  O seu codespaces será seu nó master do cluster. Para isso execute a lista de comandos abaixo:
``` shell
...
```
10. Com o nó master de pé agora é hora de provisionar o worker para isso entre na pasta com o comando `cd ~/environment/fiap-containers-e-orquestracao/03-Swarm/01-Montando-o-cluster/workers/`.
